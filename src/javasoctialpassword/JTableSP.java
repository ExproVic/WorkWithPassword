...
// Оголошуємо змінну для збереження даних
String data = "";

// Проходимо через всі рядки таблиці і отримуємо дані
for (int i = 0; i < rowCount; i++) {
    ...
    // Додаємо дані до рядка
    data += "Social Network: " + name + ", Login: " + login + ", Password: " + password + "\n";
}
        try {
            File file =new File("ListPassword.txt");
            file.createNewFile();
            if(!file.exists())
                file.createNewFile();
